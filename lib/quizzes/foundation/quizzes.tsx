...
export const foundationQuizzes = [
  ...
  {
    id: 5,
    question: 'CASE STUDY 2: Facial Recognition Access System\nA facial recognition system uses a deep neural network to grant access to a secure building.\nThe model processes:Pixel intensity values from imagesMultiple hidden layers extract facial featuresOutput layer predicts **Authorized (1)** or **Unauthorized (0)**Over time, the system improves accuracy by adjusting internal parameters.Why are hidden layers essential in this facial recognition system?',
    options: [
...
topics: ['What and How to do Model Evaluation']  }
  ...
  {
    id: 5,
    question: "Case Study 3: Sentiment Analysis Gone Wrong\n\nAn e-commerce platform deploys a sentiment analysis tool to classify reviews as positive, negative, or neutral. A review stating:\n\n> “The phone heats up so fast it could cook breakfast.”\n\nis classified as neutral.Assertion (A): The incorrect classification is due to the system’s inability to understand sarcasm and figurative language.\nReason (R): NLP models process only literal meanings of words unless trained on contextual and cultural usage.",
    options: [
      "Both A and R are true, and R is the correct explanation of A",
      "Both A and R are true, but R is NOT the correct explanation of A",
      "A is true, but R is false",
    ...
    correct: 0,
    explanation: "Sarcasm requires contextual and experiential understanding.",
    topics: ["NLP"]
  },
]
