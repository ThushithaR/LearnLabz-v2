...
export const BrownCorpus = {
  quoteOfTheDay: "One of the most striking signs of the decay of art is the intermixing of different genres.",
  quoteAttribution: "Johann Wolfgang van Goethe",
  ...
  title: 'Listing Available Genres in the Brown Corpus',
  content: {
    lines: [
      [
        {
...
},
{
    type: 'text' as const,
    title:'',
    content: `A modal verb is a helping (auxiliary) verb that adds meaning to a main verb, expressing the speaker's attitude or a situation's modality like ability, possibility, permission, or obligation. Common modals include can, could, may, might, must, shall, should, will, and would, and they always appear before the base form of the main verb.   `
},
{
    type: 'text' as const,
    title:'',
    content: `Let’s compare genres in their usage of modal verbs.`
},
