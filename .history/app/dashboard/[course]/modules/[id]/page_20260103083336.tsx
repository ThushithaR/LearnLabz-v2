...
import { AccessingTextCorporaInteractive } from "@/lib/content/nlp/unit2/AccessingTextCorpora";
import {
  ChevronLeft,
  ChevronRight,
  Clock,
                        ...
                        {section.type === 'interactive' && (
                          <div className="mt-8 pt-8 border-t border-white/10">
                            ...
                            <div className="rounded-lg border border-white/10 p-6 bg-surface/50">
                              {section.content === 'CodeWalkthrough' && <AccessingTextCorporaInteractive />}
                              {section.content !== 'CodeWalkthrough' && (section.content as React.ReactNode)}
                            </div>
                          </div>
                        )}
