    ...
    <div ref={containerRef} className="w-full max-w-6xl mx-auto bg-transparent relative my-8 font-sans">
      ...
      {hover && isVisible && (
        <div
          ...
          className="pointer-events-none absolute z-50 bg-[#1a1a1a] text-white border border-white/20 text-lg p-3 rounded-lg shadow-2xl max-w-[280px] animate-in fade-in zoom-in-95 backdrop-blur-md"
        >
