...
export const AccessingTextCorpora = {
  ...
  objectives: [
    "Understand what a text corpus is and why corpora are essential in Natural Language Processing (NLP)",
    "Identify and access built-in corpora provided by NLTK, particularly the Gutenberg Corpus",
    "Differentiate between various corpus access methods such as words(), raw(), and sents()",
    "Compute linguistic statistics such as average word length, average sentence length, and lexical diversity."
  ],
  ...
  sections: [
    ...
    },
    {
        ...
        content: `Having established that a corpus is a structured collection of texts designed for linguistic analysis, we now turn our attention to a concrete example available within NLTK. Rather than working with abstract definitions, examining a real corpus allows us to see how linguistic data is organized, accessed, and analyzed in practice. The Natural Language Toolkit (NLTK) provides access to several built-in text corpora, including the Gutenberg Corpus. This corpus contains a collection of classic literary texts from Project Gutenberg, such as works by Jane Austen, William Shakespeare, and the King James Bible. These texts are pre-tokenized and ready for linguistic analysis.`
    },
    {
