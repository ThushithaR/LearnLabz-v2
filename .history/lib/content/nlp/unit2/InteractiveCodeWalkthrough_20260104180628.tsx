  ...
  return (
    <div ref={containerRef} className="w-full max-w-4xl mx-auto bg-transparent relative">
      <div className="flex gap-6">
        ...
        {/* Right: Output */}
        <div className="w-1/2 bg-black/80 p-4 rounded-lg border border-white/10 text-sm text-white flex flex-col">
          ...
          {finished && (
            <div className="mt-4 p-3 bg-white/5 rounded flex-grow overflow-auto">
