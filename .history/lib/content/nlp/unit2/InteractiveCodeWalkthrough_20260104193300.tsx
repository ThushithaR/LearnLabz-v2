  ...
  return (
    <div ref={containerRef} className="w-full max-w-6xl mx-auto bg-transparent relative my-8 font-sans">
          ...
          <div className="flex-grow basis-[60%] min-w-[60%] max-w-[60%] bg-[#0d1117] p-6 rounded-xl border border-white/10 shadow-2xl">
            <div className="font-mono text-sm leading-relaxed">
              ...
              <div className="mt-8 pt-4 border-t border-white/5 flex items-center gap-3">
                ...
                <button onClick={next} disabled={index === tokenLines.length} className="px-6 py-2 rounded bg-white/5 text-white font-extrabold text-xs uppercase tracking-widest shadow-lg hover:brightness-110 transition-all">Next Step</button>
      ...
      {hover && isVisible && (
        ...
        >
          <div className="font-bold text-[#ff8c00] mb-1 border-b border-white/10 pb-1 font-mono uppercase tracking-tighter">{hover.text.trim() || "Formatting"}</div>
