...
export const AccessingTextCorpora = {
  ...
  sections: [
    ...
    },
    {
        ...
        content: `Having established that a corpus is a structured collection of texts designed for linguistic analysis, we now turn our attention to a concrete example available within NLTK. Rather than working with abstract definitions, examining a real corpus allows us to see how linguistic data is organized, accessed, and analyzed in practice.`
    },
    {
        type: 'text' as const,
        title: '',
