...
export const BrownCorpus = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: `The Brown Corpus can be accessed using NLTK, a Python library for natural language processing. To list the available categories in the Brown Corpus, we can use the following code:\n\n\`\`\`\nfrom nltk.corpus import brown\nbrown.categories()\n\`\`\`\nThis will return a list of categories such as 'adventure', 'belles_lettres', and 'news'.`
    },
    {
