...
import CodeWalkthroughAdvanced, { sampleCodeLines } from "./CodeWalkThrough";

// Interactive component to be rendered separately
export const AccessingTextCorporaInteractive = () => {
  return (
    <CodeWalkthroughAdvanced 
      lines={sampleCodeLines} 
      technique="Text Tokenization" 
    />
  );
};
...
Active Learning: This method reduces labeling costs by having the model analyze unlabeled text and select only the sentences it finds most "confusing" for human labeling.`
    },
    {
      ...
      content: 'CodeWalkthrough'  // Use a string identifier instead of JSX
    }
  ]
};
