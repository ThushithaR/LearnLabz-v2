    ...
    <div ref={containerRef} className="w-full max-w-4xl mx-auto bg-transparent relative">
      ...
      {hover && (
        <div
          ...
          className="pointer-events-none absolute z-50 bg-black text-neutral-100 border border-white/40 text-sm font-semibold p-3 rounded-lg shadow-lg max-w-sm break-words"
        >
