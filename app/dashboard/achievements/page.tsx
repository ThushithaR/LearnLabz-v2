...
export default function AchievementsPage() {
  ...
  if (!selectedCourse) {
    return <p className="text-center mt-20">Please select a course first.</p>;
  }

  const courseData = courses[selectedCourse];

  // Optional: add extra achievements per course
    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-textSecondary">
          Your legacy in the world of {selectedCourse.toUpperCase()}.
        </p>
      </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-textSecondary mt-1">
                {ach.desc || "Unlock requirement hidden"}
              </p>
            </div>
